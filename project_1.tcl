...
#
# Generated by Vivado on Mon Feb 03 19:47:52 -0600 2020
...
#
#    "U:/Documents/cpre488/Labs/MP-0/project_1/project_1.srcs/sources_1/bd/zynq_design_1/hdl/zynq_design_1_wrapper.vhd"
#    "U:/Documents/cpre488/Labs/MP-0/project_1/mp-0.xdc"
#
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../ip_repo/snes_intf_1.0"]" $obj
...
set files [list \
 [file normalize "${origin_dir}/project_1.srcs/sources_1/bd/zynq_design_1/hdl/zynq_design_1_wrapper.vhd" ]\
]
...
set file "hdl/zynq_design_1_wrapper.vhd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "zynq_design_1_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/mp-0.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "project_1/mp-0.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Set 'constrs_1' fileset properties
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[get_files *project_1/mp-0.xdc]" -objects $obj
set_property -name "target_ucf" -value "[get_files *project_1/mp-0.xdc]" -objects $obj
...
# Proc to create BD zynq_design_1
proc cr_bd_zynq_design_1 { parentCell } {
  ...
  iastate.edu:user:snes_intf:1.0\
...
# End of cr_bd_zynq_design_1()
cr_bd_zynq_design_1 ""
set_property REGISTERED_WITH_MANAGER "1" [get_files zynq_design_1.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files zynq_design_1.bd ] 
