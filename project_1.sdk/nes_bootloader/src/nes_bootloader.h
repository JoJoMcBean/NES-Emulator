...
#define GAME_BOOTLOADER		// Comment out to disable the bootloader and directly load "zelda.nes"
//#define JOYSTICK			// Comment out to disable the joystick and use the on-board pushbuttons
#define SNES 				1
...
static void nes_bootloader_loadThumbnail();
void xil_init();
