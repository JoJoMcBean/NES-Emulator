...
targets -set -nocase -filter {name =~"APU*" && jtag_cable_name =~ "Platform Cable USB II 0000128f4ae901"} -index 0
rst -system
after 3000
targets -set -filter {jtag_cable_name =~ "Platform Cable USB II 0000128f4ae901" && level==0} -index 1
...
ps7_init
ps7_post_config
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Platform Cable USB II 0000128f4ae901"} -index 0
dow U:/Documents/cpre488/Labs/MP-0/project_1/project_1.sdk/HelloWorld/Debug/HelloWorld.elf
