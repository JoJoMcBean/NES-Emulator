...
# JA Pmod - Bank 13
# ----------------------------------------------------------------------------
set_property PACKAGE_PIN Y11  [get_ports {pmod_JA1}];  # "JA1"
#set_property PACKAGE_PIN AA8  [get_ports {JA10}];  # "JA10"
#set_property PACKAGE_PIN AA11 [get_ports {pmod_JA2}];  # "JA2"
#set_property PACKAGE_PIN Y10  [get_ports {pmod_JA3}];  # "JA3"
#set_property PACKAGE_PIN AA9  [get_ports {pmod_JA4}];  # "JA4"
...
# JB Pmod - Bank 13
# ----------------------------------------------------------------------------
set_property PACKAGE_PIN W12 [get_ports {joystick_8bits[0]}];  # "JB1", joystick down
set_property PACKAGE_PIN W11 [get_ports {joystick_8bits[1]}];  # "JB2", joystick up
set_property PACKAGE_PIN V10 [get_ports {joystick_8bits[2]}];  # "JB3", joystick left
set_property PACKAGE_PIN W8 [get_ports {joystick_8bits[3]}];  # "JB4", joystick right
set_property PACKAGE_PIN V12 [get_ports {joystick_8bits[4]}];  # "JB7", btn select
set_property PACKAGE_PIN W10 [get_ports {joystick_8bits[5]}];  # "JB8", btn start
set_property PACKAGE_PIN V9 [get_ports {joystick_8bits[6]}];  # "JB9", btn a
set_property PACKAGE_PIN V8 [get_ports {joystick_8bits[7]}];  # "JB10", btn b

# ----------------------------------------------------------------------------
# JC Pmod - Bank 13
# ----------------------------------------------------------------------------
#set_property PACKAGE_PIN AB6 [get_ports {vout_status[3]}];  # "JC1_N"
#set_property PACKAGE_PIN AB7 [get_ports {vout_status[4]}];  # "JC1_P"
#set_property PACKAGE_PIN AA4 [get_ports {vout_status[5]}];  # "JC2_N"
#set_property PACKAGE_PIN Y4  [get_ports {vout_status[6]}];  # "JC2_P"
...
# JD Pmod - Bank 13
# ----------------------------------------------------------------------------
set_property PACKAGE_PIN W7 [get_ports {DATA_LATCH}];  # "JD1_N"
set_property PACKAGE_PIN V7 [get_ports {SNES_DATA}];  # "JD1_P"
#set_property PACKAGE_PIN V4 [get_ports {}];  # "JD2_N"
set_property PACKAGE_PIN V5 [get_ports {DATA_CLOCK}];  # "JD2_P"
