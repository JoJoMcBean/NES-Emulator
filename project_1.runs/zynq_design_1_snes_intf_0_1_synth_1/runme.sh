...
HD_PWD='U:/Documents/cpre488/Labs/MP-0/project_1/project_1.runs/zynq_design_1_snes_intf_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_design_1_snes_intf_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_design_1_snes_intf_0_1.tcl
