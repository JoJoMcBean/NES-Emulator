...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set DATA_CLOCK [ create_bd_port -dir O -type clk DATA_CLOCK ]
  set DATA_LATCH [ create_bd_port -dir O -type data DATA_LATCH ]
  set SNES_DATA [ create_bd_port -dir I -type data SNES_DATA ]
  set joystick_8bits [ create_bd_port -dir I -from 7 -to 0 -type data joystick_8bits ]
  set pmod_JA1 [ create_bd_port -dir O -type data pmod_JA1 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ {25.0} \
  ...
  # Create instance: snes_intf_0, and set properties
  set snes_intf_0 [ create_bd_cell -type ip -vlnv iastate.edu:user:snes_intf:1.0 snes_intf_0 ]
  ...
  connect_bd_intf_net -intf_net axi_vdma_0_M_AXI_MM2S [get_bd_intf_pins axi_vdma_0/M_AXI_MM2S] [get_bd_intf_pins ps7_0_axi_periph/S01_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M08_AXI [get_bd_intf_pins ps7_0_axi_periph/M08_AXI] [get_bd_intf_pins snes_intf_0/S00_AXI]

  # Create port connections
  connect_bd_net -net SNES_DATA_1 [get_bd_ports SNES_DATA] [get_bd_pins snes_intf_0/SNES_DATA]
  ...
  connect_bd_net -net joystick_8bits_1 [get_bd_ports joystick_8bits] [get_bd_pins axi_gpio_4/gpio_io_i]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_gpio_3/s_axi_aresetn] [get_bd_pins axi_gpio_4/s_axi_aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins ila_0/probe0] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/M07_ARESETN] [get_bd_pins ps7_0_axi_periph/M08_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins snes_intf_0/s00_axi_aresetn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_tc_0/s_axi_aresetn]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets rst_ps7_0_100M_peripheral_aresetn]
  connect_bd_net -net snes_intf_0_CONTROLLER_DATA [get_bd_pins axi_gpio_3/gpio_io_i] [get_bd_pins snes_intf_0/CONTROLLER_DATA]
  connect_bd_net -net snes_intf_0_DATA_CLOCK [get_bd_ports DATA_CLOCK] [get_bd_pins snes_intf_0/DATA_CLOCK]
  connect_bd_net -net snes_intf_0_DATA_LATCH [get_bd_ports DATA_LATCH] [get_bd_pins snes_intf_0/DATA_LATCH]
  ...
  connect_bd_net -net v_axi4s_vid_out_0_vid_hsync [get_bd_ports pmod_JA1] [get_bd_ports vga_hsync] [get_bd_pins v_axi4s_vid_out_0/vid_hsync]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_ports vga_blue] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_ports vga_green] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_ports vga_red] [get_bd_pins xlslice_2/Dout]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x40000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs snes_intf_0/S00_AXI/S00_AXI_reg] SEG_snes_intf_0_S00_AXI_reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41230000 [get_bd_addr_spaces axi_vdma_0/Data_MM2S] [get_bd_addr_segs axi_gpio_3/S_AXI/Reg] SEG_axi_gpio_3_Reg
  exclude_bd_addr_seg [get_bd_addr_segs axi_vdma_0/Data_MM2S/SEG_axi_gpio_3_Reg]

  create_bd_addr_seg -range 0x00010000 -offset 0x41240000 [get_bd_addr_spaces axi_vdma_0/Data_MM2S] [get_bd_addr_segs axi_gpio_4/S_AXI/Reg] SEG_axi_gpio_4_Reg
  exclude_bd_addr_seg [get_bd_addr_segs axi_vdma_0/Data_MM2S/SEG_axi_gpio_4_Reg]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x40000000 [get_bd_addr_spaces axi_vdma_0/Data_MM2S] [get_bd_addr_segs snes_intf_0/S00_AXI/S00_AXI_reg] SEG_snes_intf_0_S00_AXI_reg
  exclude_bd_addr_seg [get_bd_addr_segs axi_vdma_0/Data_MM2S/SEG_snes_intf_0_S00_AXI_reg]
